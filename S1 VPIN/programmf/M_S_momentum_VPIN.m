...
（２）做多信号：短期均线Ｓ高于长期均线Ｌ，ＣＤＦ值处在日均ＶＰＩＮ的
３１％－８５％分位数之间，则做多；
（３）做空信号：短期均线Ｓ低于长期均线Ｌ，ＣＤＦ值处在日均ＶＰＩＮ的
３１％－８５％分位数之间，则做空；
（４）平仓信号：ＣＤＦ值处在日均ＶＰＩＮ的３１％－８５％分位数之外；
...
%反转所有信号，现在进行了修正。
%1; %按照文献中方法计算 只比均线，cdf只处在日均VPIN的31-85分位
%2; %按照文献中方法计算 只比均线，cdf只处在日均 log VPIN的31-85分位
%3  %更改文献中选股方式，使用上穿代替高于，下穿代替低于 cdf只处在日均VPIN的31-85分位
%4  %更改文献中选股方式，使用上穿代替高于，下穿代替低于 cdf只处在日均VPIN的5-95分位
%5  %更改文献中选股方式，使用上穿代替高于，下穿代替低于 VPIN只处在日均VPIN的31-85分位
