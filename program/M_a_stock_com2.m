...
if eq(sel,0)
    run_mod = 'm';
    key_str = 'S42 A股组合-变动参数-多空';
else
    run_mod = 'f';
    key_str = 'S42 A股组合-固定参数-多空';
end

sql_str = 'select tradeDate,chg from S42.s42_a_stock_ef where symbol = "%s" and g_num=1 and c_m = "%s"';
